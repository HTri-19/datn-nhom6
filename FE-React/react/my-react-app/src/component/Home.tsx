...
const allProducts: Product[] = [
    ...
    // Thêm các sản phẩm hardcoded còn thiếu để có ID chính xác
    { id: 901, name: "Dell Latitude 7400", img: laptopcu3, price: 10000000, priceDisplay: "10.000.000đ" },
    { id: 902, name: "Dell Gaming G15 5520", img: laptopcu4, price: 20000000, priceDisplay: "20.000.000đ" },
    { id: 903, name: "Macbook Pro M2 13inch 16GB 512GB", img: mac2, price: 22990000, priceDisplay: "22.990.000đ" },
];
...
const Home: React.FC = () => {
    ...
    // Hàm để lấy ID sản phẩm từ tên hiển thị hardcode (ĐÃ CẬP NHẬT)
    const getHardcodedProductId = (cardTitle: string): number => {
        ...
        if (cardTitle.includes("Dell Inspiron 14 5445")) return 107; // Sản phẩm Flash Sale
        if (cardTitle.includes("Acer Nitro 5 AN515-57")) return 108; // Sản phẩm Laptop Cũ 1
        if (cardTitle.includes("ASUS TUF A15 FA506")) return 109; // Sản phẩm Laptop Cũ 2
        if (cardTitle.includes("Laptop ASUS VivoBook Go 14 E1404FA-NK177W")) return 110; // Sản phẩm Asus Vivobook
        if (cardTitle.includes("Macbook Pro M2 13inch 16GB 512GB")) return 903; // Macbook 2 (ID giả lập)
    ...
    return (
        <>
            ...
            <section className="product-category">
                <div className="container">
                    ...
                    <div className="product-list">
                        ...
                        <div className="product-card">
                            <img src={laptop1} alt="Lenovo LOQ" />
                            <h3>
            ...
            {/* FLASH SALE SECTION (Đã sửa nút Thêm vào Giỏ hàng) */}
            <section className="flash-sale">
                <div className="container">
                    ...
                    <div className="product-list-item mt-5">
                        <div className="product-card">
                            <img src={laptopdell} alt="Dell Inspiron" />
                            <h3>
                            ...
                            {/* Thêm nút Thêm vào giỏ hàng cho Flash Sale */}
                            <button 
                                onClick={() => handleAddToCart(getHardcodedProductId("Dell Inspiron 14 5445"))} 
                                className="btn-success"
                                style={{marginTop: '10px'}} // Thêm style tạm để nút không dính sát
                            >
                                <i className="fa-solid fa-cart-shopping"></i> Thêm vào giỏ hàng
                            </button>
                        ...
                        {/* ... Các product-card khác trong flash-sale ... (Cần thêm nút Thêm vào giỏ hàng tương tự nếu có) */}
                    </div>
            ...
            {/* NEWEST PRODUCTS SECTION - Laptop cũ (Đã sửa nút Thêm vào Giỏ hàng) */}
            <section className="product-category mt-5">
                <div className="container">
                    ...
                    <div className="product-list">
                        <div className="product-card">
                            <img src={laptopcu1} alt="Acer Nitro 5" />
                            <h3>
                        ...
                        <div className="product-card">
                             <img src={laptopcu2} alt="ASUS TUF A15" />
                            <h3>
                        ...
                        {/* Thêm các sản phẩm laptop cũ khác nếu muốn thêm chức năng giỏ hàng */}
                        <div className="product-card">
                            <img src={laptopcu3} alt="Dell Latitude 7400" />
                            <h3>Dell Latitude 7400 | Core i7 8665U 16GB 512GB FHD</h3>
                            <p className="price-new"> 10.000.000đ</p>
                            <div className="price-info">
                                <span className="price-old">12.000.000đ</span>
                                <span className="discount"> Giảm 17% </span>
                            </div>
                             <button 
                                onClick={() => handleAddToCart(getHardcodedProductId("Dell Latitude 7400"))} 
                                className="btn-success"
                            >
                                <i className="fa-solid fa-cart-shopping"></i> Thêm vào giỏ hàng
                            </button>
                        ...
                        <div className="product-card">
                            <img src={laptopcu4} alt="Dell Gaming G15 5520" />
                            <h3>Dell Gaming G15 5520 | Core i5-12500H 16GB RTX 3050</h3>
                            <p className="price-new"> 20.000.000đ</p>
                            <div className="price-info">
                                <span className="price-old">24.000.000đ</span>
                                <span className="discount"> Giảm 17% </span>
                            </div>
                             <button 
                                onClick={() => handleAddToCart(getHardcodedProductId("Dell Gaming G15 5520"))} 
                                className="btn-success"
                            >
                                <i className="fa-solid fa-cart-shopping"></i> Thêm vào giỏ hàng
                            </button>
            ...
            {/* MACBOOK SECTION (Đã sửa nút Thêm vào Giỏ hàng) */}
            <section className="product-category mt-5">
                <div className="container">
                    <div className="product-list">
                        <div className="product-card">
                            <Link to="/product_detail">
                                <img src={mac1} alt="Macbook Air M2" />
                                <h3>Macbook Air M2 13inch 16GB 256GB | New</h3>
                            </Link>
                            <p className="price-new">19.290.000đ</p>
                            <div className="price-info">
                        ...
                        <div className="product-card">
                            <img src={mac2} alt="MacBook Pro M2" />
                        ...
                        {/* Thêm các sản phẩm macbook khác nếu muốn thêm chức năng giỏ hàng */}
                        <div className="product-card">
                            <img src={mac3} alt="Macbook Pro 14inch M1 Pro" />
                            <h3>Macbook Pro 14inch M1 Pro 16GB 1TB | New</h3>
                            <p className="price-new">29.990.000đ</p>
                            <div className="price-info">
                                <span className="price-old">42.990.000đ</span>
                        ...
                        <div className="product-card">
                            <img src={mac4} alt="MacBook Pro M3 Pro 14 inch" />
                            <h3>MacBook Pro M3 Pro 14 inch (18GB 512GB)</h3>
                            <p className="price-new">36.990.000đ</p>
                            <div className="price-info">
                                <span className="price-old">45.990.000đ</span>
                                <span className="discount">Giảm 20%</span>
                            </div>
                             <button 
                                onClick={() => handleAddToCart(getHardcodedProductId("MacBook Pro M3 Pro 14 inch (18GB 512GB)"))} 
                                className="btn-success"
                            >
                                <i className="fa-solid fa-cart-shopping"></i> Thêm vào giỏ hàng
                            </button>
            ...
            {/* Asusvivobook (Đã sửa nút Thêm vào Giỏ hàng) */}
            <section className="product-category mt-5">
                <div className="container">
                    <div className="product-list">
                        <div className="product-card">
                        ...
                        <div className="product-card">
                            <img src={Asusvivobook2} alt=" Asusvivobook 2" />
                            <h3>Laptop ASUS VivoBook 2</h3>
                            <p className="price-new"> 12.000.000đ</p>
                            <div className="price-info">
                                <span className="price-old">15.000.000đ</span>
                                <span className="discount">Giảm 20%</span>
                            </div>
                            {/* Dùng ID giả lập vì không có trong allProducts */}
                            <button 
                                onClick={() => handleAddToCart(999)} 
                                className="btn-success"
                            >
                                <i className="fa-solid fa-cart-shopping"></i> Thêm vào giỏ hàng
                            </button>
            ...
            <footer className="footer">
                <div className="footer-top">
                    ...
                    {/* Thêm cột cuối cùng cho footer nếu thiếu */}
                     <div className="footer-column contact-info">
                        <h3>Liên hệ</h3>
                        <p>Địa chỉ: 123 Đường ABC, Quận XYZ, TP.HCM</p>
                        <p>Điện thoại: 1900 1234</p>
                        <p>Email: info@ttcenter.com</p>
                ...
                <div className="footer-bottom">
                    <p>&copy; 2025 T&T Center. All rights reserved.</p>
